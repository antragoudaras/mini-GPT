...
class GPTLightningModule(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.global_step % self.config.generate_every_n_steps == 0:
            ...
            for single_sent in generated_sents:
                self.logger.experiment.add_text('Training texts for single generation', single_sent, self.global_step)
...
def train(args):
    ...
    lightning_model = lightning_model.to(args.device)
    print(f"Switching lighting model to : {lightning_model.device}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_type', type=str, default='gpt2', help="Define the gpt2 version to be initialised")
    ...
    parser.add_argument('--num_workers', type=int, default=4, help='Num cpu workers used for training')
